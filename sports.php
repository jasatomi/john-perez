...
<html>
  ...
  <style type="text/css">
    #homecontent{
  background: url("background/sports.jpg");
...
body{
  ...
  <?php
   echo "<div id='minicontent1'><img id='imagestyles' src='background/logo2.png' width='400px' height='200px'><div id='share-buttons'>
    ...
    <a href='http://www.facebook.com/sharer.php?u=http://localhost/kaya_yan/sports.php' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/facebook.png' alt='Facebook' />
    </a>
    
    
    <a href='https://plus.google.com/share?url=http://localhost/kaya_yan/sports.php' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/google.png' alt='Google' />
    </a>
   
    
    <a href='http://www.tumblr.com/share/link?url=http://localhost/kaya_yan/sports.php&amp;title=Simple Share Buttons' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/tumblr.png' alt='Tumblr' />
    </a>
     
    
    <a href='https://twitter.com/share?url=http://localhost/kaya_yan/sports.php&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons' target='_blank'>
