...
<html>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <li class=""><a href="home.php">Home <span class="sr-only">(current)</span></a></li>
        <li class="active"><a href="">Money <span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Categories <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="sports.php">Sports</a></li>
            <li><a href="showbiz.php">Showbiz</a></li>
  ...
  <style type="text/css">
    #homecontent{
  background: url("background/money.jpg");
...
body{
  ...
  <?php
   echo "<div id='minicontent1'><img id='imagestyles' src='background/logo2.png' width='400px' height='200px'><div id='share-buttons'>
    ...
    <a href='http://www.facebook.com/sharer.php?u=http://localhost/kaya_yan/money.php' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/facebook.png' alt='Facebook' />
    </a>
    
    
    <a href='https://plus.google.com/share?url=http://localhost/kaya_yan/money.php' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/google.png' alt='Google' />
    </a>
   
    
    <a href='http://www.tumblr.com/share/link?url=http://localhost/kaya_yan/money.php&amp;title=Simple Share Buttons' target='_blank'>
        <img src='http://localhost/kaya_yan/icons/tumblr.png' alt='Tumblr' />
    </a>
     
    
    <a href='https://twitter.com/share?url=http://localhost/kaya_yan/money.php&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons' target='_blank'>
